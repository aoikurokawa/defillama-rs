    ...
    ReentrancyGuardUpgradeable
{
    ...
    mapping(uint256 => mapping(uint256 => Order[])) oderBook;
    mapping(address => mapping(uint256 => uint256)) sharesReserved;
    InitialNftFractionsRepository nftFractionsRepository;

    function __WatchDexBase_init() public initializer {
        __Countext_init_unchained();
        __Pausable_init_unchained();
        __Ownable_init_unchained();
    }

    function setNftFractionsRepository(address nftFractionsRepositoryAddress) public onlyOwner {
        nftFractionsRepository = InitialNftFractionsRepository(
    ...
    /**
     * Creates a market order and executes against the registered limit orders
     */
