...
import "./InitialNftFractionsRepository.sol";
    ...
    InitialNftFractionsRepository
{
    ...
    /**
     * when someone transfers his tokens to the other chain the bridge contract will call this burn function
    ...
    /**
     * when someone transfers his tokens from the other chain to this chain the bridge contract will call this mint function
     *
     * Requirements:
     * - only the owner (the bridge contract = owner) can call
     * - the contract is not paused
    ...
    /**
     * same as safeTransferFrom in ERC1155 with one restriction:
     * - the contract is not paused
     *
    ...
    /**
     * returns amount of fractions minted for a token
     */
    ...
    /**
     * returns original ERC721 contract address for a token
     */
